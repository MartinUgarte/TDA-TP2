import unittest
from aproximacion_grupo import empaquetamiento_aproximado_grupo

class TestAproximacionGrupo(unittest.TestCase):

    def test_no_hay_objetos(self):
        T = []
        resultado = []
        self.assertEqual(len(empaquetamiento_aproximado_grupo(T)[0]), len(resultado))
